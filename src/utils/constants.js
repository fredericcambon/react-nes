...
export var ROMS = [ {
    ...
    label: 'Castlevania',
    slug: 'castlevania',
    cover: 'https://upload.wikimedia.org/wikipedia/en/2/24/Castlevania_NES_box_art.jpg',
    filepath: 'castlevania.nes'
}, {
    value: 6,
    label: 'Ice Climber',
    slug: 'ice-climber',
    cover: 'https://upload.wikimedia.org/wikipedia/en/d/df/IceClimberboxartnes.jpg',
