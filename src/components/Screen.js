...
class Screen extends Observer {
    ...
    render() {
        return (
            <div>
                <canvas className="nes-screen-canvas" ref="canvasDst" style={{width: "100%", height: "100%"}}></canvas>
                <div id="overlay" style={{position: "absolute", bottom: 0, left:0, right: 0, zIndex: 2, height: "3rem"}}>
